...
axios.interceptors.response.use(
  ...
  (error) => {
    ...
    if (url.includes("/api/stats")) {
      ...
      data = [
        { id: "TICK-1048", title: "Falla de enlace de fibra en Galpón Principal", user_name: "Carlos Mendoza", category: "Redes, Switches & Conectividad", priority: "ALTA", status: "EN_PROCESO", created_at: "2026-09-07T10:15:00Z", description: "Corte intermitente en switch principal de distribución." },
        { id: "TICK-1047", title: "Instalación de Punto de Venta POS Terminal 4", user_name: "Elena Rivas", category: "Sistemas Administrativos & ERP", priority: "MEDIA", status: "RESUELTO", created_at: "2026-09-07T09:30:00Z", description: "Configuración de driver fiscal y conexión con base de datos." },
        { id: "TICK-1046", title: "Alerta de temperatura en Servidor Dell R750", user_name: "Luis Uzcategui", category: "Soporte de Hardware & Servidores", priority: "URGENTE", status: "RESUELTO", created_at: "2026-09-07T08:00:00Z", description: "Limpieza preventiva y cambio de pasta térmica en nodos 1 y 2." },
        { id: "TICK-1045", title: "Configuración de Backup automatizado en NAS", user_name: "Roberto Gómez", category: "Mantenimiento Preventivo & Respaldos", priority: "BAJA", status: "RESUELTO", created_at: "2026-09-06T16:20:00Z", description: "Programación de tareas cron nocturnas a las 02:00 AM." },
        { id: "TICK-1044", title: "Sustitución de Baterías en UPS APC Smart 3000VA", user_name: "Javier Castillo", category: "Soporte de Hardware & Servidores", priority: "MEDIA", status: "RESUELTO", created_at: "2026-09-06T11:45:00Z", description: "Reemplazo de módulo de celdas 12V 9Ah y prueba de transferencia." }
      ];
